...
const { RentProperty } = require('../models');
...
exports.getAll = async (req, res) => {
  try {
    ...
    const { count, rows } = await RentProperty.findAndCountAll({
      where,
...
exports.getOne = async (req, res) => {
  try {
    const property = await RentProperty.findByPk(req.params.id);
...
exports.create = async (req, res) => {
  try {
    ...
    const property = await RentProperty.create({
...
exports.remove = async (req, res) => {
  try {
    ...
    // Delete files non-blocking — do not throw on failure
